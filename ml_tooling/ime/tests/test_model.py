...
class TestBatchClassifyPosts:
    ...
    def test_successful_batch_processing(
        ...
        input_posts = [
            {'uri': 'uri1', 'text': 'text1', 'batch_id': 'batch1', 'preprocessing_timestamp': '2024-01-01'},
            {'uri': 'uri2', 'text': 'text2', 'batch_id': 'batch1', 'preprocessing_timestamp': '2024-01-01'}
        ]
    ...
    def test_metric_collection(
        ...
        input_posts = [
            {'uri': 'uri1', 'text': 'short', 'batch_id': 'batch1', 'preprocessing_timestamp': '2024-01-01'},
            {'uri': 'uri2', 'text': 'very long text', 'batch_id': 'batch1', 'preprocessing_timestamp': '2024-01-01'}
        ]
