...
def create_condition_visualizations(condition_analysis: Dict, output_dir: str):
    ...
    # 1. Top 10 entities by condition (bar chart)
    ...
    for i, condition in enumerate(conditions):
        counts = [condition_analysis[condition].get(entity, 0) for entity in top_entities]
...
def create_rank_change_visualization(ranking_comparison: Dict, output_dir: str, filename_prefix: str):
    ...
    # Add legend
    legend_elements = [
        plt.Rectangle((0,0),1,1, facecolor='darkgreen', alpha=0.8, label='Improved Rank'),
        plt.Rectangle((0,0),1,1, facecolor='darkred', alpha=0.8, label='Declined Rank'),
