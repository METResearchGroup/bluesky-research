...
class TestWriteJsonDumpedRecordsToLocalStore:
    ...
    def setup_mocks(self, mocker):
        ...
        mock_load = mocker.patch("lib.db.manage_local_data._load_json_data_from_directory")
        mock_write = mocker.patch("lib.db.manage_local_data._write_json_records_to_local_store")
...
class TestWriteJsonsToLocalStore:
    ...
    def setup_mocks(self, mocker):
        """Fixture to set up common mocks for tests."""
        mock_create_dir = mocker.patch("lib.db.manage_local_data.create_directory_if_not_exists")
        mock_write_records = mocker.patch("lib.db.manage_local_data._write_json_records_to_local_store")
        mock_write_dumped = mocker.patch("lib.db.manage_local_data._write_json_dumped_records_to_local_store")
