...
# Rolling window (in calendar days) aligned with study analytics when joining
# in-feed URIs to preprocessed posts and related label pools.
FEED_LOOKBACK_DAYS_DURING_STUDY = 5
