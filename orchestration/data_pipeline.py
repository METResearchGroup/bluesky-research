...
def run_ml_inference_sociopolitical():
    """Performs ML inference on the latest data using the sociopolitical classifier."""
    bash_script_path = os.path.join(
...
def production_data_pipeline():
    ...
    job_run_ml_inference_ime = run_ml_inference_ime.submit(
        wait_for=[job_preprocess_raw_data]
    )
