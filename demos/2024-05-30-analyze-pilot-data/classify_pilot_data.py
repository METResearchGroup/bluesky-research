...
def main(
    ...
    transformed_preprocessed_posts_dicts = [
        {
            ...
            **{
                ...
                # Ensure it's None if NaN
                "filtered_by_func": post["filtered_by_func"] if post["filtered_by_func"] is not None else None,
                # Ensure it's None if NaN
                "indexed_at": post["indexed_at"] if post["indexed_at"] is not None else None
            }
        }
    ...
    if classification_type == "perspective":
        ...
        print(
            f"Inserting {len(invalid_posts_models)} invalid posts into the DB.")
        ...
        print(
            f"Running batch classification on {len(valid_posts)} valid posts.")
