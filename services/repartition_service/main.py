...
def repartition_service(payload: dict) -> None:
    ...
    Behavior:
        ...
        3. Calls helper function to process each partition date:
            a. Creates backup of original data
            b. Verifies backup integrity
            c. Repartitions data with new key
            d. Verifies repartitioned data
