...
from services.filter_raw_data.classify_hate_speech.model import classify
...
def classify_single_post(post: dict) -> dict:
    ...
    return {"uri": post["uri"], "has_hate_speech": has_hate_speech}


def classify_if_posts_have_hate_speech(
