...
class FilteredPreprocessedPostModel(BaseModel):
    ...
    indexed_at: Optional[str] = Field(default=None, description="The timestamp of when the post was indexed by Bluesky.")  # noqa
    ...
    filtered_by_func: Optional[str] = Field(default=None, description="Function used to filter the post")  # noqa
