...
class TestLoadPreprocessedPosts:
    ...
    def test_base_case(self, mock_load_data):
        ...
        """
        empty_df = pd.DataFrame(columns=["uri", "text", "preprocessing_timestamp"])
        ...
        expected_substrings = [
            ...
            "SELECT uri, text, preprocessing_timestamp",
    ...
    def test_output_format_list(self, mock_load_data):
        ...
        mock_df = pd.DataFrame({
            "uri": ["post1", "post2"],
            "text": ["text1", "text2"],
            "preprocessing_timestamp": ["2023-01-01", "2023-01-02"]
        })
    ...
    def test_sorted_ascending(self, mock_load_data):
        ...
        expected_substrings = [
            "SELECT uri, text, preprocessing_timestamp, partition_date",
            "FROM preprocessed_posts",
    ...
    def test_combined_results(self, mock_load_data):
        ...
        active_df = pd.DataFrame({
            "uri": ["post3", "post4"],
            "text": ["text3", "text4"],
            "preprocessing_timestamp": ["2023-01-03", "2023-01-04"]
        })
    ...
    def test_convert_ts_fields(self, mock_load_data):
        ...
        Expected outputs:
            ...
            - preprocessing_timestamp is converted to YYYY-MM-DD-HH:MM:SS format
        """
        mock_df = pd.DataFrame({
            "uri": ["post1"],
            "preprocessing_timestamp": pd.to_datetime(["2023-01-01T12:00:00Z"]),
        ...
        assert result["preprocessing_timestamp"].iloc[0] == "2023-01-01-12:00:00"
...
class TestLoadPostsToBackfill:
    ...
    def test_load_posts_to_backfill_specific_integration(self, mock_load_uris, mock_load_posts, mock_preprocessed_posts, mock_post_uris):
        ...
        mock_load_posts.assert_called_once_with(
            ...
            sorted_by_partition_date=False,
            ascending=False,
            table_columns=["uri", "text", "preprocessing_timestamp"],
            output_format="list"
        )
