...
class ConnectionModel(BaseModel):
    ...
    connection_type: te.Literal["follow", "follower"] = Field(
...
class UserToConnectionModel(BaseModel):
    ...
    user_follows_connection: bool = Field(
        ..., description="Whether the user follows the connection."
    )  # noqa
    connection_follows_user: bool = Field(
        ..., description="Whether the connection follows the user."
    )  # noqa
    synctimestamp: str = Field(..., description="The synctimestamp of the connection.")  # noqa
...
class UserSocialNetworkCountsModel(BaseModel):
    ...
    user_did: str = Field(..., description="The DID of the user.")
    user_handle: str = Field(..., description="The handle of the user.")
    user_followers_count: int = Field(
        ..., description="The number of followers the user has."
    )  # noqa
    user_following_count: int = Field(
