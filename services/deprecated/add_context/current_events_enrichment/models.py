...
class NewsOutletModel(BaseModel):
    ...
    outlet_id: str = Field(description="The ID of the news outlet.")
    domain: str = Field(description="The domain of the news outlet.")
    political_party: str = Field(description="The political party of the news outlet.")
    synctimestamp: str = Field(description="The timestamp of the sync.")
...
class NewsArticleModel(BaseModel):
    ...
    content: Optional[str] = Field(description="The content of the news article.")
    description: Optional[str] = Field(
        description="The description of the news article."
    )
    publishedAt: str = Field(description="The published date of the news article.")
