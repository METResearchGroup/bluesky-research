...
class ThreadPostContextModel(BaseModel):
    ...
    text: Optional[str] = Field(default="", description="The text of the post.")
    embedded_image_alt_text: Optional[str] = Field(
        default="", description="The alt text of the embedded image in the post."
    )
...
class ThreadContextModel(BaseModel):
    ...
    thread_root_post: Optional[ThreadPostContextModel] = Field(
        default=None, description="The root post of the thread."
    )
    thread_parent_post: Optional[ThreadPostContextModel] = Field(
        default=None, description="The parent post of the post we're analyzing."
    )
...
class ContextEmbedUrlModel(BaseModel):
    ...
    url: Optional[str] = Field(
        default=None, description="The URL in the embed of the post."
    )
...
class ContextUrlInTextModel(BaseModel):
    ...
    has_trustworthy_news_links: Optional[bool] = Field(
        default=False, description="Whether the post has trustworthy news links."
    )
...
class PostLinkedUrlsContextModel(BaseModel):
    ...
    embed_url_context: ContextEmbedUrlModel = Field(
        default=None, description="Information about the URL in the embed of the post."
    )
...
class PostTagsLabelsContextModel(BaseModel):
    ...
    post_tags: Optional[str] = Field(default=None, description="The tags of the post.")
    post_labels: Optional[str] = Field(
        default=None, description="The labels of the post."
    )
