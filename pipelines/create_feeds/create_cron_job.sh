...
# This bash script will create a cron job that creates feeds via main.py everyday at 3am Eastern Time (currently UTC-5)/2am Central.
...
echo "Cron jobs created to create feeds everyday at 2am Central Time."
