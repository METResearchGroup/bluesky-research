"""Tests for ime handler."""

import json
import pytest
from unittest.mock import patch
from pipelines.classify_records.ime import handler
...
class TestLambdaHandler:
    def test_lambda_handler_default_event(self):
        ...
        with patch(
            "pipelines.classify_records.ime.handler.classify_latest_posts",
            return_value=mock_model,
        ):
            result = handler.lambda_handler(None, None)
            assert result["status_code"] == 200
            assert result["service"] == "ml_inference_ime"
    ...
    def test_handler_bracket_notation_access(self):
        ...
        with patch(
            ...
            assert metadata["inference_type"] == "ime"
