...
def lambda_handler(event, context) -> dict:
    try:
        ...
        logger.info("Starting intergroup classification of latest posts.")
        ...
        logger.info("Completed intergroup classification of latest posts.")
        ...
        session_status_metadata = {
            ...
            "status_code": 500,
            "body": json.dumps(f"Error in intergroup classification of latest posts: {str(e)}"),
            "metadata_table_name": dynamodb_table_name,
