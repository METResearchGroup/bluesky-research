# This bash script will create a cron job that runs the sbatch submit_job.sh twice per day.
...
echo "Cron job created to run sbatch submit_job.sh twice per day."
